...
inline void SelectKernelRunMulti(InputFileData* InputData, NuclearData* NucData_gpu, MagnetizationData* MagData_gpu,
                                 StructureData* StructData_gpu, RotationData* RotData_gpu, ScatteringData* SANSData,
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 0 &&
        InputData->StructData_activate_flag == 0 && InputData->RotData_activate_flag == 0) {
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 0 &&
        InputData->StructData_activate_flag == 1 && InputData->RotData_activate_flag == 0) {
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 1 &&
        ...
        Atomistic_NuMagSANS_Kernel<<<(L + 255) / 256, 256>>>(*NucData_gpu, *MagData_gpu, *StructData_gpu,
                                                             *SANSData_gpu);
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 0 &&
        InputData->StructData_activate_flag == 0 && InputData->RotData_activate_flag == 1) {
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 1 &&
        ...
        Atomistic_NuMagSANS_Kernel_RotDilute<<<(L + 255) / 256, 256>>>(*NucData_gpu, *MagData_gpu, *RotData_gpu,
                                                                       *SANSData_gpu);
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 0 &&
        InputData->StructData_activate_flag == 1 && InputData->RotData_activate_flag == 1) {
        LogSystem::write("run: Atomistic_MagSANS_Kernel_StructRot");
        Atomistic_MagSANS_Kernel_StructRot<<<(L + 255) / 256, 256>>>(*MagData_gpu, *StructData_gpu, *RotData_gpu,
                                                                     *SANSData_gpu);
    ...
    if (InputData->MagData_activate_flag == 0 && InputData->NucData_activate_flag == 1 &&
        ...
        Atomistic_NucSANS_Kernel_StructRot<<<(L + 255) / 256, 256>>>(*NucData_gpu, *StructData_gpu, *RotData_gpu,
                                                                     *SANSData_gpu);
    ...
    if (InputData->MagData_activate_flag == 1 && InputData->NucData_activate_flag == 1 &&
        ...
        Atomistic_NuMagSANS_Kernel_StructRot<<<(L + 255) / 256, 256>>>(*NucData_gpu, *MagData_gpu, *StructData_gpu,
                                                                       *RotData_gpu, *SANSData_gpu);
        CheckCUDAKernelRun("Atomistic_NuMagSANS_Kernel_StructRot");
    }
}

inline void SelectKernelRun(InputFileData* InputData, NuMagSANSData* Data) {

    SelectKernelRunMulti(InputData, &Data->NucData_gpu, &Data->MagData_gpu, &Data->StructData_gpu, &Data->RotData_gpu,
