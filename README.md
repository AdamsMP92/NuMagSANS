...
- **Atomistic systems**, featuring complex crystal lattices — e.g., data generated from atomistic spin-dynamics simulations with [*Vampire 5.0*](https://vampire.york.ac.uk/).  
- **Mesoscopic systems**, such as micromagnetic models — e.g., within toolchains involving [*MuMax3*](https://mumax.github.io/) or [*OOMMF*](https://math.nist.gov/oommf/).  
