...
.. _program_listing_file_src_gpu_kernels_AtomisticMagSANS_StructKernel.h:

Program Listing for File AtomisticMagSANS_StructKernel.h
========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_gpu_kernels_AtomisticMagSANS_StructKernel.h>` (``src/gpu_kernels/AtomisticMagSANS_StructKernel.h``)
...
.. code-block:: cpp
   ...
   // Computes purely magnetic atomistic SANS for an explicitly structured system.
   // Active data layers:
   ...
   //   - RotationData
   // Use case:
   //   Magnetic scattering from an assembly with explicit object positions, where
   //   all objects share the same local orientation convention.
   //
   // Placeholder for:
   // Atomistic_MagSANS_Kernel
   
   __global__ void Atomistic_MagSANS_Kernel(MagnetizationData MagData, StructureData StructData, ScatteringData SANSData) {
