...
.. _program_listing_file_src_helper_NuMagSANSlib_StringCompare.h:

Program Listing for File NuMagSANSlib_StringCompare.h
=====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_helper_NuMagSANSlib_StringCompare.h>` (``src/helper/NuMagSANSlib_StringCompare.h``)
...
.. code-block:: cpp
   ...
   void CheckStrings_ElementNames(std::string* Names, int Number_Of_Names, bool* CheckFlag, std::string* Nom,
                                  std::string* Type) {
