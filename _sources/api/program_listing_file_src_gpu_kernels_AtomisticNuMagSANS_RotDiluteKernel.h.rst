...
.. _program_listing_file_src_gpu_kernels_AtomisticNuMagSANS_RotDiluteKernel.h:

Program Listing for File AtomisticNuMagSANS_RotDiluteKernel.h
=============================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_gpu_kernels_AtomisticNuMagSANS_RotDiluteKernel.h>` (``src/gpu_kernels/AtomisticNuMagSANS_RotDiluteKernel.h``)
...
.. code-block:: cpp
   ...
   __global__ void Atomistic_NuMagSANS_Kernel_RotDilute(NuclearData NucData, MagnetizationData MagData,
