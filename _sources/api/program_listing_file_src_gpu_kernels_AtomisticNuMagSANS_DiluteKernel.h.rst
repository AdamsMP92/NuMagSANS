...
.. _program_listing_file_src_gpu_kernels_AtomisticNuMagSANS_DiluteKernel.h:

Program Listing for File AtomisticNuMagSANS_DiluteKernel.h
==========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_gpu_kernels_AtomisticNuMagSANS_DiluteKernel.h>` (``src/gpu_kernels/AtomisticNuMagSANS_DiluteKernel.h``)
...
.. code-block:: cpp
   ...
   // Computes combined nuclear and magnetic atomistic SANS for a dilute system.
   // Active data layers:
   ...
   //   - RotationData
   // Use case:
   //   Single-object or dilute-ensemble nuclear-magnetic scattering without
   //   explicit object centers and without object-wise rotations.
   //
   // Placeholder for:
   // Atomistic_NuMagSANS_Kernel_dilute
   
   __global__ void Atomistic_NuMagSANS_Kernel_dilute(NuclearData NucData, MagnetizationData MagData,
