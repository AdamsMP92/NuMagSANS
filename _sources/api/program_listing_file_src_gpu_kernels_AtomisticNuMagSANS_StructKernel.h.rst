...
.. _program_listing_file_src_gpu_kernels_AtomisticNuMagSANS_StructKernel.h:

Program Listing for File AtomisticNuMagSANS_StructKernel.h
==========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_gpu_kernels_AtomisticNuMagSANS_StructKernel.h>` (``src/gpu_kernels/AtomisticNuMagSANS_StructKernel.h``)
...
.. code-block:: cpp
   ...
   // Computes combined nuclear and magnetic atomistic SANS for an explicitly
   // structured system.
   // Active data layers:
   ...
   //   - RotationData
   // Use case:
   //   Nuclear-magnetic scattering from an assembly with explicit object
   //   positions, where all objects share the same local orientation convention.
   //
   // Placeholder for:
   // Atomistic_NuMagSANS_Kernel
   
   __global__ void Atomistic_NuMagSANS_Kernel(NuclearData NucData, MagnetizationData MagData, StructureData StructData,
