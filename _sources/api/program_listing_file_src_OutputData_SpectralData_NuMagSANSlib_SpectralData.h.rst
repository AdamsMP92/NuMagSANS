...
.. _program_listing_file_src_OutputData_SpectralData_NuMagSANSlib_SpectralData.h:

Program Listing for File NuMagSANSlib_SpectralData.h
====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_OutputData_SpectralData_NuMagSANSlib_SpectralData.h>` (``src/OutputData/SpectralData/NuMagSANSlib_SpectralData.h``)
...
.. code-block:: cpp
   ...
   #include "NuMagSANSlib_SpectralData2csv.h"
   #include "NuMagSANSlib_SpectralData2hdf5.h"
   ...
   void scale_SpectralData(ScalingFactors* ScalFactors, SpectralData* SpecData, InputFileData* InputData) {
       ...
       for (unsigned long int l = 0; l < L; l++) {
           ...
           SpecData->I_Mag_non_spin_flip_pp[l] =
               SpecData->I_Nuc_unpolarized[l] + SpecData->I_NucMag[l] + SpecData->I_Mag_polarized[l];
           SpecData->I_Mag_non_spin_flip_mm[l] =
               SpecData->I_Nuc_unpolarized[l] - SpecData->I_NucMag[l] + SpecData->I_Mag_polarized[l];
       ...
       for (unsigned int k = 0; k < Lk; ++k) {
           ...
           SpecData->A_Mag_non_spin_flip_pp[k] =
               SpecData->A_Nuc_unpolarized[k] + SpecData->A_NucMag[k] + SpecData->A_Mag_polarized[k];
           SpecData->A_Mag_non_spin_flip_mm[k] =
               SpecData->A_Nuc_unpolarized[k] - SpecData->A_NucMag[k] + SpecData->A_Mag_polarized[k];
   ...
   void allocate_SpectralData_GPU(SpectralData* SpecData, SpectralData* SpecData_gpu) {
   ...
   void init_SpectralData(InputFileData* InputData, ScatteringData* SANSData, SpectralData* SpecData,
   ...
   void copyGPU2RAM_SpectralData(SpectralData* S, SpectralData* S_gpu) {
   ...
   void free_SpectralData(SpectralData* S, SpectralData* S_gpu) {
