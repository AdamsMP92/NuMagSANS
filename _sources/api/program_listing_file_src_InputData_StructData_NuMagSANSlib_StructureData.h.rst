...
.. _program_listing_file_src_InputData_StructData_NuMagSANSlib_StructureData.h:

Program Listing for File NuMagSANSlib_StructureData.h
=====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_InputData_StructData_NuMagSANSlib_StructureData.h>` (``src/InputData/StructData/NuMagSANSlib_StructureData.h``)
...
.. code-block:: cpp
   ...
   void allocate_StructureDataRAM(StructureData* StructData, StructDataProperties* StructDataProp,
       ...
       if (!StructData->x || !StructData->y || !StructData->z || !StructData->K || !StructData->RotMat) {
   ...
   void allocate_StructureDataGPU(StructureData* StructData, StructureData* StructData_gpu) {
   ...
   void copy_StructureDataRAM2GPU(StructureData* StructData, StructureData* StructData_gpu) {
   ...
   void read_StructureData(StructureData* StructData, StructDataProperties* StructDataProp, InputFileData* InputData) {
   ...
   void init_StructureData(StructureData* StructData, StructureData* StructData_gpu, StructDataProperties* StructDataProp,
                           InputFileData* InputData) {
   ...
   void init_StructureDataMemory(StructureData* StructData, StructureData* StructData_gpu,
                                 StructDataProperties* StructDataProp, InputFileData* InputData) {
   
       allocate_StructureDataRAM(StructData, StructDataProp, InputData);
       allocate_StructureDataGPU(StructData, StructData_gpu);
   }
   
   void new_read_StructureData(StructureData* StructData, StructureData* StructData_gpu,
                               StructDataProperties* StructDataProp, InputFileData* InputData) {
   ...
   void free_StructureData(StructureData* StructData, StructureData* StructData_gpu) {
   ...
   void disp_StructureData(StructureData* StructData) {
       for (int k = 0; k < *StructData->K; k++) {
           cout << StructData->x[k] << " " << StructData->y[k] << " " << StructData->z[k] << "\n";
       }
   }
