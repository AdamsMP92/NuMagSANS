...
.. _program_listing_file_src_wrapper_NuMagSANSlib_KernelPostprocess.h:

Program Listing for File NuMagSANSlib_KernelPostprocess.h
=========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_wrapper_NuMagSANSlib_KernelPostprocess.h>` (``src/wrapper/NuMagSANSlib_KernelPostprocess.h``)
...
.. code-block:: cpp
   ...
   inline void KernelPostprocessRunMulti(InputFileData* InputData, ScatteringData* SANSData, ScatteringData* SANSData_gpu,
   ...
   inline void KernelPostprocessRun(InputFileData* InputData, NuMagSANSData* Data) {
   
       KernelPostprocessRunMulti(InputData, &Data->SANSData, &Data->SANSData_gpu, &Data->SpecData_gpu);
   }
