...
.. _program_listing_file_src_gpu_kernels_AtomisticMagSANS_RotDiluteKernel.h:

Program Listing for File AtomisticMagSANS_RotDiluteKernel.h
===========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_gpu_kernels_AtomisticMagSANS_RotDiluteKernel.h>` (``src/gpu_kernels/AtomisticMagSANS_RotDiluteKernel.h``)
...
.. code-block:: cpp
   ...
   // Computes purely magnetic atomistic SANS for a dilute orientation ensemble.
   // Active data layers:
   ...
   //   - StructureData
   // Use case:
   //   Magnetic scattering from a dilute ensemble of rotated local objects without
   //   explicit object-center positions.
   //
   // Placeholder for:
   // Atomistic_MagSANS_Kernel_RotDilute
   
   __global__ void Atomistic_MagSANS_Kernel_RotDilute(MagnetizationData MagData, RotationData RotData,
       ...
       if (i < L) {
           for (int k = 0; k < K; k++) {
               ...
               for (int l = 0; l < N_act; l++) {
                   ...
                   //  + MagData.RotMat[3] * yr \
                   // + MagData.RotMat[6] * zr;
                   Y = MagData.RotMat[1] * xr + MagData.RotMat[4] * yr + MagData.RotMat[7] * zr;
                   Z = MagData.RotMat[2] * xr + MagData.RotMat[5] * yr + MagData.RotMat[8] * zr;
